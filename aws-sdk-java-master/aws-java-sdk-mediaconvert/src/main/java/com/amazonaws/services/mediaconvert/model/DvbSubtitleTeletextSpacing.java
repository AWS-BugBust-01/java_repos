...
/**
 * Specify whether the Text spacing (TextSpacing) in your captions is set by the captions grid, or varies depending on
 * letter width. Choose fixed grid (FIXED_GRID) to conform to the spacing specified in the captions file more
